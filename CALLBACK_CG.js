...
var name = 'CALLBACK_CG';
var CALLBACK_CG = function CALLBACK_CG(obj) {
  if ((typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) === 'object') {
    (0, _config.WinJSDec)(function (_) {
      window.WinJSBridge.call('navigation', 'depositoryBack', obj);
    });
  } else {
    throw new TypeError('[' + name + '] ' + _config.objError);
  }
};
exports.default = CALLBACK_CG;
//# sourceMappingURL=CALLBACK_CG.js.map